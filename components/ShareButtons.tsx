...
export function ShareButtons({ url, title, className = '', showLabel = true }: ShareButtonsProps) {
  ...
  const RedditIcon = () => (
    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      <path d="M12 0A12 12 0 000 12a12 12 0 0012 12 12 12 0 0012-12A12 12 0 0012 0zm5.01 4.744c.688 0 1.25.561 1.25 1.249a1.25 1.25 0 01-2.498.056l-2.597-.547-.899 2.065c1.376.097 2.637.442 3.754.968 1.378-.636 3.08-.442 3.08.644 0 1.356-1.65 1.882-3.255 1.868.012.028.024.056.024.087 0 2.215-3.322 4.012-7.42 4.012-4.099 0-7.42-1.797-7.42-4.012 0-.032.012-.059.023-.087-1.425.005-3.08-.52-3.08-1.868 0-1.123 1.655-1.206 3.008-.744 1.13-.536 2.409-.884 3.8-.981l1.125-2.425c-.058-.004-.116-.004-.174-.004z" />
    </svg>
  );
  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      {showLabel && (
        <span className="text-sm text-[#6d4a4a] font-medium flex-shrink-0 flex items-center gap-2">
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <button
        ...
        className="w-10 h-10 rounded-full bg-[#6d4a4a]/10 text-[#6d4a4a] hover:bg-[#6d4a4a] hover:text-white transition-all flex items-center justify-center"
