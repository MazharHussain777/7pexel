...
export function PhonesHero({ phonesCount = 0, brandsCount = 0 }: PhonesHeroProps) {
  return (
    <section className="relative rounded-[24px] overflow-hidden mt-5 bg-gradient-to-br from-[#0A3F26] via-[#0F6B3E] to-[#1FA25A] text-white">
      <div className="relative z-10 p-8 md:p-11 flex flex-wrap justify-between gap-7">
        <div className="max-w-[600px]">
          ...
          <h1 className="font-fraunces font-medium text-[clamp(2.2rem,4.6vw,3.5rem)] tracking-[-0.03em] leading-[1.1]">
            Smartphone <em className="italic not-italic text-[#D4F26B]">Directory</em>
          </h1>
          <p className="mt-3.5 text-white/80 text-[1rem] leading-[1.6] max-w-[560px]">
        ...
        <div className="flex gap-0 flex-wrap items-start">
          <div className="flex flex-col gap-1 px-6.5 border-l border-white/22 first:border-l-0 first:pl-0">
            ...
            <span className="font-jetbrains-mono text-[0.62rem] tracking-[0.1em] uppercase text-white/72">Phones</span>
          </div>
          <div className="flex flex-col gap-1 px-6.5 border-l border-white/22 first:border-l-0 first:pl-0">
          ...
          <div className="flex flex-col gap-1 px-6.5 border-l border-white/22 first:border-l-0 first:pl-0">
            ...
            <span className="font-jetbrains-mono text-[0.62rem] tracking-[0.1em] uppercase text-white/72">Latest Models</span>
          </div>
        </div>
      </div>
