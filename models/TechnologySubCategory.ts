...
const TechnologySubCategorySchema = new Schema<ITechnologySubCategory>(
  {
    ...
    metaTitle: {
      ...
      default: function(this: any) {
        return `${this.name} — Expert Guides & Tutorials | 7pexel`;
      }
    },
    metaDescription: {
      type: String,
      trim: true,
      default: function(this: any) {
        return `Expert ${this.name.toLowerCase()} guides, tutorials, and best practices. Learn ${this.name.toLowerCase()} with our comprehensive resources.`;
      }
    },
    keywords: {
      type: [String],
