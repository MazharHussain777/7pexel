  ...
  const jsonLd = {
    ...
    "breadcrumb": {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": cat.name, "item": `https://7pexel.com/technology/category/${cat.slug}` },
      ],
    },
  };
        ...
        <main>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 md:pt-8">
            <nav className="flex items-center gap-2 text-[0.8rem] text-[#5a7a6a] flex-wrap" aria-label="Breadcrumb">
              <Link href="/" className="hover:text-[#011d24] transition-colors duration-200">Home</Link>
              <span className="text-[#c5d8d2] select-none" aria-hidden="true">/</span>
              <Link href="/technology" className="hover:text-[#011d24] transition-colors duration-200">Technology</Link>
              <span className="text-[#c5d8d2] select-none" aria-hidden="true">/</span>
              <span className="text-[#011d24] font-semibold capitalize" aria-current="page">{cat.name}</span>
            </nav>
          </div>
          ...
          <section className="w-full bg-white border-t border-[#d8e2df] py-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-10">
                <h3 className="text-sm font-semibold text-[#1a7a6a] uppercase tracking-wider mb-2">Explore More</h3>
                <h2 className="text-3xl font-bold text-[#2c3e3a]">Other Technology Categories</h2>
